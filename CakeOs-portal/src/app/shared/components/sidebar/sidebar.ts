...
export class Sidebar {
  ...
  readonly menuItems: MenuItem[] = [
    { label: 'Dashboard', icon: this.icon('dashboard'), route: '/facturas' },
    { label: 'Clientes', icon: this.icon('clientes') },
    { label: 'Productos', icon: this.icon('productos') },
    { label: 'Pedidos', icon: this.icon('pedidos') },
    { label: 'Pagos', icon: this.icon('pagos') },
    { label: 'Reportes', icon: this.icon('reportes') },
    { label: 'Security', icon: this.icon('security') },
  ];
